 ...
 *
 * <p>Existe porque el paso 4 del generador pide marcar «he leído y acepto el aviso de privacidad» y
 * hasta ahora ese enlace era un 404. Pedir que alguien acepte un documento que no se puede leer no
 * es un descuido de maquetación: es recoger un consentimiento que no lo es.
 *
 * <p><b>Es RGPD, no LFPDPPP.</b> El modelo del que se partió era mexicano —«Aviso de Privacidad»
 * con «Derechos ARCO»— y FORMA es un producto español: catálogo de supermercado de aquí, país por
 * defecto `ES`, y datos de salud que el propio código ya identifica como categoría especial del
 * artículo 9. Traducir aquella estructura habría dejado fuera cuatro cosas que el artículo 13
 * exige: la base jurídica de cada tratamiento, el plazo de conservación, el derecho a retirar el
 * consentimiento y el derecho a reclamar ante la AEPD.
 *
 * <p><b>Todo lo que dice esta página lo hace el código.</b> Cada tratamiento descrito abajo se
 * corresponde con una tabla, y cada plazo con algo que lo cumple: los doce meses del lead los borra
 * `PlanLeadRetentionJob`. Un aviso que promete más de lo que el programa hace es el mismo problema
 * que un botón que no hace nada, con consecuencias peores.
 *
 * <p><b>Los `[COMPLETAR …]` son deliberados.</b> AGENTS.md prohíbe inventar lo que la especificación
 * no dice, y la razón social, el NIF, el domicilio y el proveedor de alojamiento no están en el
 * repositorio. Se marcan como la portada marca `[COMPLETAR PRECIO]`: visibles, imposibles de
 * publicar sin darse cuenta. <b>Esta página no está lista para producción hasta que no quede
 * ninguno</b>, y conviene que la revise alguien de legal antes.
 */
      ...
      <article className={styles.doc}>
        <header className={styles.head}>
          ...
          <p className={styles.lead}>
            En corto: los usamos para construirte el plan que pides y para que la aplicación
            funcione. No los vendemos, no los cedemos a nadie que no sea necesario para prestarte el
            servicio, y no llevamos ninguna herramienta de analítica ni de rastreo.
          </p>
          <p className={styles.version}>Última actualización: {VERSION}</p>
        </header>
        ...
        <section className={styles.section} aria-labelledby="datos">
          ...
          <p>
            El generador de la portada recoge tu <strong>nombre</strong> y tu{' '}
            <strong>correo</strong> —para poder enviarte el plan—, tu <strong>país</strong> y, si
            quieres decirlo, <strong>cómo nos encontraste</strong>. Y las respuestas con las que se
            calcula el plan: <strong>sexo, edad, peso, altura, nivel de actividad, objetivo</strong>
            , cuántos días y cuántas comidas quieres y qué estilo de alimentación prefieres.
            Guardamos también el requerimiento calórico que te enseñamos, para que el plan que
            recibas se pueda comparar con la cifra que viste.
          </p>
          <p className={styles.note}>
            El generador{' '}
            <strong>no pregunta por patologías, alergias ni restricciones alimentarias</strong>, y
            no hay ningún sitio donde guardarlas. Son datos de salud y no los recogemos en un
            formulario público.
          </p>

          <h3 className={styles.h3}>Si te creas una cuenta</h3>
          <p>
            Tu <strong>correo</strong> y tu <strong>contraseña</strong> —que se guarda cifrada, no
            en claro—, y los datos de perfil que rellenes: nombre, fecha de nacimiento, sexo, altura
            y los objetivos que te marques.
          </p>
          ...
          <p>
            ...
            <strong>fotos de progreso</strong>, lo que comes y bebes, tus sesiones de entrenamiento
            y su seguimiento, tus objetivos y tus listas de la compra.
          </p>
          <p className={styles.note}>
            Buena parte de esto son <strong>datos de salud</strong>: categoría especial del artículo
            9 del RGPD. Los tratamos solo con tu consentimiento explícito, que es lo que das al
        ...
        <section className={styles.section} aria-labelledby="finalidades">
            ...
            <table className={styles.table}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Nuestro interés legítimo en que el servicio no se caiga ni se use para spam
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <p className={styles.note}>
            La casilla de novedades es <strong>independiente</strong> de la de privacidad a
            propósito: aceptar que te mandemos lo que has pedido y aceptar que te escribamos después
            son dos preguntas distintas, y puedes decir que sí a una y que no a la otra.
          </p>
        </section>
        ...
        <section className={styles.section} aria-labelledby="plazos">
          ...
          <dl className={styles.definitions}>
            ...
            <div>
              ...
              <dd>
                Guardamos qué aceptaste, cuándo y qué versión de este aviso estaba en vigor. Es lo
                que el artículo 7.1 nos exige poder demostrar.
              </dd>
            </div>
          </dl>
        </section>
        ...
        <section className={styles.section} aria-labelledby="destinatarios">
          ...
          <p className={styles.note}>
            ...
            SEGÚN EL PROVEEDOR DE ALOJAMIENTO — si hay transferencia, hay que declarar la garantía
            que la ampara].
          </p>
        </section>
        ...
        <section className={styles.section} aria-labelledby="derechos">
          ...
          <ul className={styles.list}>
            ...
            <li>
              <strong>Retirar tu consentimiento</strong> en cualquier momento, sin que eso afecte a
              lo que hicimos antes de retirarlo.
            </li>
          </ul>
          <p>
            ...
            ). Preferiríamos que nos lo dijeras a nosotros primero, pero es tu derecho y no hace
            falta que pases por aquí.
          </p>
        </section>
        ...
        <section className={styles.section} aria-labelledby="cookies">
          ...
          <p>
            ...
            Analytics, ni píxeles, ni nada parecido. Por eso no verás un banner de cookies
            pidiéndote permiso: lo que guardamos es estrictamente necesario para que la aplicación
            funcione, y para eso el permiso no hace falta.
          </p>
          <ul className={styles.list}>
            <li>
        ...
        <section className={styles.section} aria-labelledby="menores">
          ...
          <p>
            ...
            ley española permite consentir el tratamiento de los propios datos. El generador no
            acepta una edad por debajo de 14. Si detectamos datos de alguien más joven, los
            borramos.
          </p>
        </section>
        ...
        <section className={styles.section} aria-labelledby="seguridad">
          ...
          <p>
            ...
            por HTTPS. El acceso a la base de datos está restringido a quien hace falta para operar
            el servicio.
          </p>
          <p className={styles.note}>
        ...
        <section className={styles.section} aria-labelledby="automatizado">
          ...
          <p>
            El requerimiento calórico y el plan se calculan automáticamente, con una fórmula
            estándar (Mifflin-St Jeor). Es un cálculo, no una decisión sobre ti con efectos
            jurídicos, y como decimos en el propio generador:{' '}
            <strong>

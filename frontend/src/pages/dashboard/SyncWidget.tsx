 ...
 *
 * <p>"Ver más" now points at `/settings/integrations` (FOR-57's standalone
 * integrations screen) instead of the still-placeholder `/settings` — this
 * widget's own data stays the static FOR-51 chip; only the link target moved.
 */
export function SyncWidget() {
  return (
    <WidgetSection id="sync-widget-title" title="Integraciones" linkTo="/app/settings/integrations">

 ...
 * /integrations}; extended by FOR-132 with {@code duplicatesSkipped}). Carries no token/secret
 * (ADR-004) — only the safe, user-readable fields.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record SyncOutcomeResponse(
    String result, int importedCount, int duplicatesSkipped, String message) {
